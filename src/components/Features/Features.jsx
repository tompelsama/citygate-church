  ...
  <section className="bg-black pb-52">
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        <p className="font-young-serif text-lg text-blue-50">
          Our Weekly Gatherings
        </p>
        <p className="max-w-md font-young-serif text-lg text-blue-50 opacity-50">
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_2">
          <div className="flex size-full flex-col justify-between bg-[#fdf0e0] p-5">
